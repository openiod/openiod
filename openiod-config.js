...
module.exports = {
	...
	init: function (name) {
		...
		systemConfigStr 			= fs.readFileSync(systemConfigLocalPath + "openiod-system.json");
	...
	getSignature: function (id) {
		var _tokenSignature = null;
		if (systemConfig.signature && systemConfig.signature[id]) {
			_tokenSignature 	= systemConfig.signature[id];
		}  
