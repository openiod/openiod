...
//			res.contentType('text/xml');
			...
			if (query.commit == 'true') {
				...
				// uitgezet ivm omschakelen naar Fiware:  self.testExecuteInsertObservation(req, res, query, _param, self, xmlDocument);
			}
...
//			res.contentType('text/xml');
			...
			if (query.inputformat == 'executeinsertom') {
				// uitgeschakeld ivm omschakeling naar Fiware. Moet nog wel naar Fiware worden omgebouwd: self.testExecuteInsertObservation(req, res, query, _param, self, xmlDocument);
			}
...
//					res.contentType('text/xml');
					...
					// deze functie is uitgeschakeld en wordt niet omgezet naar Fiware: self.testExecuteInsertObservation(req, res, query, _param, self, xmlDocument);
...
//		res.send(document);
	...
	sendFiwareData: function(data) {
		var _url = 'https://orion.openiod.org/v2/entities?options=keyValues'; //openiodUrl;
